...
public sealed class UnicastAddressInventoryTests
{
    ...
    {
        var guidA = Guid.Parse("dd8cd9a1-0b6f-4e6e-9a86-06f1aeb0a1f0");
        var guidB = Guid.Parse("11223344-5566-7788-99aa-bbccddeeff00");
        var rows = new[]
        {
    ...
    {
        var guid = Guid.Parse("dd8cd9a1-0b6f-4e6e-9a86-06f1aeb0a1f0");
        var rows = new[]
        {
    ...
    public void GroupFingerprintsSkipsInterfacesTheResolverCannotName()
    {
        ...
        Assert.Equal([guid.ToString("D")], fingerprints.Keys.ToArray());
    }
